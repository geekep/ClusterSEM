...
#' @param ld A folder (or folders) of partitioned LD scores used as the independent variable in S-LDSC.
#' @param wld A folder of non-partitioned LD scores used as regression weights.
...
#' @return S  The zero-order genetic covariance matrices for each annotation
#' @return V  The zero-order sampling covariance matrices for each annotation
#' @return S_Tau  The tau matrices for each annotation
#' @return V_Tau  The tau sampling covariance matrices for each annotation
